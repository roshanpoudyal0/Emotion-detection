...
if __name__ == '__main__':
    ...
    while rval:
        ...
        if key == 32: # press space to save images
            ...
            if mouth != 2: # did not return error
                ...
                if result == 1:
                    from Tkinter import *
		    root = Tk()
		    root.title("DETECTED RESULT")
		    root.geometry("200x200")
		    txt=Label(root,text="It seems You are smiling :)")
		    txt.pack()
		    root.mainloop()
                else:
                    from Tkinter import *
		    ...
		    root.title("DETECTED RESULT")
		    root.geometry("200x200")
		    txt=Label(root,text="It seems You are not smiling:|")
		    txt.pack()
		    root.mainloop()
            else:
                from Tkinter import *
		...
		txt=Label(root,text="Failed to Detect Mouth.Try hold your head straight and make sure there is only one face ")
		txt.pack()
		root.mainloop()
